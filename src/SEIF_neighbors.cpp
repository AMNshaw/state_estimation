...
//         self.h(0) = r;
//         self.h(1) = std::acos(E_ns(2)/r) - (mav_self_data.RPY(1) + M_PI_2);
// 		self.h(2) = std::atan2(E_ns(1), E_ns(0)) - mav_self_data.RPY(2);
...
//         self.H(1, 0) = -(E_ns(2) * E_ns(0)) / (pow(r, 2) * sqrt(pow(E_ns(0), 2)+pow(E_ns(1), 2)));
//         self.H(1, 1) = -(E_ns(2) * E_ns(1)) / (pow(r, 2) * sqrt(pow(E_ns(0), 2)+pow(E_ns(1), 2)));
//         self.H(1, 2) =  sqrt(pow(E_ns(0), 2)+pow(E_ns(1), 2)) / pow(r, 2);

//         self.H(2, 0) = E_ns(1)/((pow(E_ns(0), 2)+pow(E_ns(1), 2)));
//         self.H(2, 1) = -E_ns(0)/((pow(E_ns(0), 2)+pow(E_ns(1), 2)));
//         self.H(2, 2) = 0;
